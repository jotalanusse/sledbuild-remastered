...
-- 		PLAYERSTATS ..
-- 		" ( id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, steamid INTEGER, won, lost INTEGER, topspeed FLOAT, mapname TEXT );")
...
-- 	end
-- 	sql.Query("UPDATE " ..
-- 		PLAYERSTATS .. " SET topspeed = " .. topspeed .. ", won = " .. won .. ", lost = " ..
-- 		lost .. " WHERE steamid = " .. sid .. ";")
-- end
...
-- 		end
-- 	end
-- 	if ply and ply:IsPlayer() and consolespam then
