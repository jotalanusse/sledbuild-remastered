...
-- 	end)
-- 	if not _G['HM'] and not _G['lastRace'] then
-- 		_G['HM'] = _G['tHM']
-- 		_G['lastRace'] = _G['tLastRace']
-- 	elseif not _G['lastRace'] then
-- 		_G['lastRace'] = _G['tLastRace']
-- 	elseif not _G['HM'] then
-- 		_G['HM'] = _G['tHM']
-- 	else
...
-- 		if (v == myself) then
-- 			--nil
-- 		elseif (myself:Team() == TEAM_RACING and v:Team() == TEAM_RACING) then
...
-- 			draw.SimpleTextOutlined(tostring(plyspeed) .. " MPH", "ScoreboardText", pos.x, pos.y + 16 * 2, thecolor, 1, 1, 1,
-- 				thecolor2)
...
-- 			end
-- 			draw.SimpleTextOutlined("( " .. tostring(plyspeedisgreater .. plyspeeddelta .. " )"), "ScoreboardText", pos.x,
-- 				pos.y + 16 * 3, thecolor, 1, 1, 1, thecolor2)
-- 		end
-- 	end
-- end
...
-- 	elseif not _G['HM'] then
-- 		_G['HM'] = _G['tHM']
-- 	elseif not _G['FirstPosition'] or not _G['SecondPosition'] or not _G['ThirdPosition'] then
...
-- 	if NextRace == 0 and not startsoundplayed then
...
-- 	draw.DrawText(math.Round(NextRace), "ScoreboardText", slbclockx - 26, slbclocky + 64 * slbclockz + 8, slbnextracecolor,
-- 		1)
...
-- 	-- Stats
-- 	draw.DrawText("Top Three in " .. Won .. " out of " .. Won + Lost .. " races", "ScoreboardText", 13, 30,
-- 		Color(255, 255, 255, 255), 0, 0)

-- 	-- Building Racing
-- 	draw.DrawText("Racing: " .. HowManyRacing .. " of " .. TotalPlayers .. " players", "ScoreboardText", 13, 50,
-- 		Color(255, 255, 255, 255), 0, 0)
...
-- 	draw.DrawText("(" .. currenttopspeed .. " MPH)", "ScoreboardText", slbspeedx, slbspeedy + 64 + 16,
-- 		Color(150, 150, 150, 255), 1)
-- 	draw.DrawText("" .. speedstr .. " MPH", "ScoreboardText", slbspeedx, slbspeedy + 64 + 16 + 12, Color(150, 150, 150, 255)
-- 		, 1)
