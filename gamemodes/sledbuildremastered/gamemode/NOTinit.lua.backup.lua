...
-- -- SledBuild Remastered server file
-- include('shared.lua')
...
-- GLOBAL["FirstPosition"] = "N/A"
-- GLOBAL["SecondPosition"] = "N/A"
-- GLOBAL["ThirdPosition"] = "N/A"
-- GLOBAL["HowMany"] = 0
-- GLOBAL["lastRace"] = 0
...
-- 	player:ConCommand("pp_bloom 0") -- Disable Bloom Rape
...
-- 		v:PrintMessage(HUD_PRINTTALK, "[SledBuild R] " .. player:Nick() .. " finished joining the server.")
-- 	end

-- 	PST_PlayerInitialSpawn(pl) -- Register the player stats
-- end
...
-- 	player:SetNetworkedBool("IsRacing", false) -- The players starts as builder
-- 	-- pl:SetNetworkedBool("OnTrack", false) -- The player starts off the track TODO: Remove?
-- 	player:SetCollisionGroup(COLLISION_GROUP_WEAPON)
-- 	player:SelectWeapon("weapon_physgun")
-- 	player:SetTeam(TEAM_BUILDING)	-- Set to team building

-- 	-- SendHelp(player) -- TODO: What this do?

-- 	net.Start("RaceVariables") -- Start a new message
-- 	net.WriteFloat(GLOBAL["HowMany"])
-- 	net.WriteFloat(GLOBAL["lastRace"])
-- 	net.Send(player)
