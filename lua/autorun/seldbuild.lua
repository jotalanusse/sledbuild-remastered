...
-- 			shadow = drop_shadow or false, outline = outlined or false, blursize = oblur or 0, scanlines = scanline or 0 })
...
-- 		return surface.CreateOldFont(font_name, osize, oweight, aa, oadditive, new_font_name, drop_shadow, outlined, oblur,
-- 			scanline)
-- 	else
